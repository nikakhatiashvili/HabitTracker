...
internal fun RoundedLinearProgressIndicator(
    ...
    backgroundColor: Color = color.copy(alpha = ProgressIndicatorDefaults.circularColor.alpha)
) {
    Canvas(
        modifier
        ...
        drawRoundedLinearIndicatorTrack(trackColor,strokeWidth)
...
private fun DrawScope.drawRoundedLinearIndicatorTrack(
    color: Color,
    strokeWidth: Float
